...
public class SearchForm {
    ...
    public List<SearchParameter> toList() {
        ...
        list.add(new SearchParameter(6,"datecreatedd","Дата создания больше",((datecreatedd!=null)&&(!datecreatedd.equals("")))?datecreatedd:"",(datecreatedd!=null)?"disabled":"", "date"));
        list.add(new SearchParameter(7,"datecreatedu","Дата создания меньше",((datecreatedu!=null)&&(!datecreatedu.equals("")))?datecreatedu:"",(datecreatedu!=null)?"disabled":"", "date"));
        return list;
    }
}
